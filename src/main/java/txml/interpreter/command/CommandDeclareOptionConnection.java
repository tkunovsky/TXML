...
public class CommandDeclareOptionConnection implements Command {
    ...
    public void execute(InstructionsInterpreter interpreter, String operand1, String operand2, String operand3, String result) throws SQLException, TXmlException {
        Connection dbConnection = DriverManager.getConnection(operand2);
        interpreter.setConnection(dbConnection);
        interpreter.setNewConnection(true);
    }
